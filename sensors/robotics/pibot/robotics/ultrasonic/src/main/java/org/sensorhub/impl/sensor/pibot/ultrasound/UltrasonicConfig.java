...
/**
 * Configuration settings for the UltrasonicSensor driver exposed via the OpenSensorHub Admin panel.
 *
 ...
 * @since Jan. 24, 2021
 */
public class UltrasonicConfig extends SensorConfig {
    ...
    public String serialNumber = "ultrasonic-sensor";
    ...
    public UltrasonicPinConfig pinConfig = new UltrasonicPinConfig();
}
